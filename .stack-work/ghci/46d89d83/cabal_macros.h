...
/* package quizify-0.1 */
#ifndef VERSION_quizify
#define VERSION_quizify "0.1"
#endif /* VERSION_quizify */
#ifndef MIN_VERSION_quizify
#define MIN_VERSION_quizify(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "quizify-0.1-H98BrKZZTUrBzmIkmcPqOq-quizify-exe"
